...
\noindent \textit{\small{Source of \Cref{fig:uart_ttl}: \url{https://amzn.eu/d/3QKPgB9}}}\\
...
\noindent \textit{\small{Source of socket sympol in \Cref{fig:mod_trig_connector}: \url{https://cdn-reichelt.de/documents/datenblatt/C160/MAB\%205S-ROHS_XX.pdf}}}\\
...
\noindent \textit{\small{Source of \Cref{fig:din_plug_socket}: \url{https://cdn-reichelt.de/bilder/web/xxl_ws/C160/MAS_50.png} \\  \url{https://cdn-reichelt.de/bilder/web/xxl_ws/C160/MAB_5.png}}}\\
...
\noindent \textit{\small{Source of \Cref{fig:gn_case}: \url{https://amzn.eu/d/eWSlyFs}}}\\
